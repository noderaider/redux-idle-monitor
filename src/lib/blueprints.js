...
export const activityBlueprint = createBlueprint(ACTIVITY_BLUEPRINT, ({ x, y, isTransition }) => ({ activeStatus: IDLESTATUS_ACTIVE, lastActive: +new Date(), lastEvent: { x, y }, isTransition }))
